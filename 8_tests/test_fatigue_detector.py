...
class TestFatigueScore:
    def test_default_components_is_empty_dict(self):
        fs = FatigueScore(
            player_id=1, player_name="", game_id="G1",
            game_date=date.today(), overall_fatigue=0.0,
        )
    ...
    def test_stores_overall_fatigue(self):
        fs = FatigueScore(
            player_id=1, player_name="", game_id="G1",
            game_date=date.today(), overall_fatigue=0.50,
        )
    ...
    def test_not_high_risk(self):
        fs = FatigueScore(
            player_id=1, player_name="", game_id="G1",
            game_date=date.today(), overall_fatigue=0.20,
        )
        assert fs.is_high_risk is False
...
class TestPitcherFatigueRestScore:
    def test_rest_six_days_is_zero(self):
        ...
        r = d.evaluate_pitcher_fatigue(
            player_id=1, player_name="A", game_id="G1",
            game_date=date.today(), rest_days=6,
            avg_velo_last_30d=95, avg_velo_last_3g=95,
            avg_spin_last_30d=2400, avg_spin_last_3g=2400,
            pitches_thrown_last_7d=0, innings_pitched_last_7d=0,
        )
    ...
    def test_rest_three_days_score(self):
        ...
        r = d.evaluate_pitcher_fatigue(
            player_id=1, player_name="A", game_id="G1",
            game_date=date.today(), rest_days=3,
            avg_velo_last_30d=95, avg_velo_last_3g=95,
            avg_spin_last_30d=2400, avg_spin_last_3g=2400,
            pitches_thrown_last_7d=0, innings_pitched_last_7d=0,
        )
    ...
    def test_rest_one_day_score(self):
        ...
        r = d.evaluate_pitcher_fatigue(
            player_id=1, player_name="A", game_id="G1",
            game_date=date.today(), rest_days=1,
            avg_velo_last_30d=95, avg_velo_last_3g=95,
            avg_spin_last_30d=2400, avg_spin_last_3g=2400,
            pitches_thrown_last_7d=0, innings_pitched_last_7d=0,
        )
    ...
    def test_rest_four_days_score(self):
        ...
        r = d.evaluate_pitcher_fatigue(
            player_id=1, player_name="A", game_id="G1",
            game_date=date.today(), rest_days=4,
            avg_velo_last_30d=95, avg_velo_last_3g=95,
            avg_spin_last_30d=2400, avg_spin_last_3g=2400,
            pitches_thrown_last_7d=0, innings_pitched_last_7d=0,
        )
...
class TestPitcherFatigueVeloDrop:
    def test_velo_drop_above_threshold_scales_linearly(self):
        ...
        r = d.evaluate_pitcher_fatigue(
            player_id=1, player_name="A", game_id="G1",
            game_date=date.today(), rest_days=5,
            avg_velo_last_30d=96.0, avg_velo_last_3g=93.0,
            avg_spin_last_30d=2400, avg_spin_last_3g=2400,
            pitches_thrown_last_7d=0, innings_pitched_last_7d=0,
        )
    ...
    def test_velo_drop_small_positive(self):
        ...
        r = d.evaluate_pitcher_fatigue(
            player_id=1, player_name="A", game_id="G1",
            game_date=date.today(), rest_days=5,
            avg_velo_last_30d=96.0, avg_velo_last_3g=95.0,
            avg_spin_last_30d=2400, avg_spin_last_3g=2400,
            pitches_thrown_last_7d=0, innings_pitched_last_7d=0,
        )
    ...
    def test_velo_drop_capped_at_one(self):
        ...
        r = d.evaluate_pitcher_fatigue(
            player_id=1, player_name="A", game_id="G1",
            game_date=date.today(), rest_days=5,
            avg_velo_last_30d=96.0, avg_velo_last_3g=85.0,
            avg_spin_last_30d=2400, avg_spin_last_3g=2400,
            pitches_thrown_last_7d=0, innings_pitched_last_7d=0,
        )
...
class TestPitcherFatigueSpinDrop:
    def test_spin_drop_above_threshold(self):
        ...
        r = d.evaluate_pitcher_fatigue(
            ...
            game_date=date.today(), rest_days=5,
            avg_velo_last_30d=95, avg_velo_last_3g=95,
            avg_spin_last_30d=2500, avg_spin_last_3g=2200,
            pitches_thrown_last_7d=0, innings_pitched_last_7d=0,
        )
    ...
    def test_spin_drop_small_positive(self):
        ...
        r = d.evaluate_pitcher_fatigue(
            ...
            game_date=date.today(), rest_days=5,
            avg_velo_last_30d=95, avg_velo_last_3g=95,
            avg_spin_last_30d=2500, avg_spin_last_3g=2400,
            pitches_thrown_last_7d=0, innings_pitched_last_7d=0,
        )
...
class TestPitcherFatiguePitchLoad:
    def test_pitch_load_scales(self):
        ...
        r = d.evaluate_pitcher_fatigue(
            ...
            avg_velo_last_30d=95, avg_velo_last_3g=95,
            avg_spin_last_30d=2400, avg_spin_last_3g=2400,
            pitches_thrown_last_7d=150, innings_pitched_last_7d=10,
        )
    ...
    def test_pitch_load_capped(self):
        ...
        r = d.evaluate_pitcher_fatigue(
            ...
            avg_velo_last_30d=95, avg_velo_last_3g=95,
            avg_spin_last_30d=2400, avg_spin_last_3g=2400,
            pitches_thrown_last_7d=400, innings_pitched_last_7d=20,
        )
...
class TestPitcherFatigueOverall:
    ...
    def test_multiple_factors_compound(self):
        ...
        r = d.evaluate_pitcher_fatigue(
            player_id=1, player_name="A", game_id="G1",
            game_date=date.today(), rest_days=2,
            avg_velo_last_30d=96, avg_velo_last_3g=92,
            avg_spin_last_30d=2500, avg_spin_last_3g=2200,
            pitches_thrown_last_7d=180, innings_pitched_last_7d=12,
            tz_crossings_last_3d=3, travel_miles_last_3d=2800,
            is_day_game_after_night=True,
        )
    ...
    def test_overall_capped_at_one(self):
        ...
        r = d.evaluate_pitcher_fatigue(
            player_id=1, player_name="A", game_id="G1",
            game_date=date.today(), rest_days=0,
            avg_velo_last_30d=100, avg_velo_last_3g=80,
            avg_spin_last_30d=3000, avg_spin_last_3g=1500,
            pitches_thrown_last_7d=500, innings_pitched_last_7d=30,
            tz_crossings_last_3d=13, travel_miles_last_3d=30000,
            is_day_game_after_night=True,
        )
...
class TestPitcherFatigueFields:
    def test_velo_drop_field(self):
        ...
        r = d.evaluate_pitcher_fatigue(
            player_id=1, player_name="A", game_id="G1",
            game_date=date.today(), rest_days=5,
            avg_velo_last_30d=96.5, avg_velo_last_3g=94.0,
            avg_spin_last_30d=2400, avg_spin_last_3g=2400,
            pitches_thrown_last_7d=0, innings_pitched_last_7d=0,
        )
    ...
    def test_spin_drop_field(self):
        ...
        r = d.evaluate_pitcher_fatigue(
            ...
            game_date=date.today(), rest_days=5,
            avg_velo_last_30d=95, avg_velo_last_3g=95,
            avg_spin_last_30d=2550, avg_spin_last_3g=2400,
            pitches_thrown_last_7d=0, innings_pitched_last_7d=0,
        )
    ...
    def test_pitch_count_field(self):
        ...
        r = d.evaluate_pitcher_fatigue(
            ...
            avg_velo_last_30d=95, avg_velo_last_3g=95,
            avg_spin_last_30d=2400, avg_spin_last_3g=2400,
            pitches_thrown_last_7d=185, innings_pitched_last_7d=12.0,
        )
    ...
    def test_player_info(self):
        d = FatigueDetector()
        r = d.evaluate_pitcher_fatigue(
            player_id=42, player_name="Shohei Ohtani", game_id="G1",
            game_date=date(2026, 5, 20), rest_days=5,
            avg_velo_last_30d=95, avg_velo_last_3g=95,
            avg_spin_last_30d=2400, avg_spin_last_3g=2400,
            pitches_thrown_last_7d=0, innings_pitched_last_7d=0,
        )
...
class TestBatterFatigue:
    def test_rested_batter_low_fatigue(self):
        ...
        r = d.evaluate_batter_fatigue(
            player_id=1, player_name="A", game_id="G1",
            game_date=date.today(), rest_days=6,
            woba_last_14d=0.350, woba_last_7d=0.360,
            hard_hit_pct_last_14d=0.45, hard_hit_pct_last_7d=0.46,
        )
    ...
    def test_woba_drop_increases_fatigue(self):
        ...
        r = d.evaluate_batter_fatigue(
            player_id=1, player_name="A", game_id="G1",
            game_date=date.today(), rest_days=5,
            woba_last_14d=0.350, woba_last_7d=0.250,
            hard_hit_pct_last_14d=0.45, hard_hit_pct_last_7d=0.44,
        )
    ...
    def test_no_woba_drop_no_score(self):
        ...
        r = d.evaluate_batter_fatigue(
            player_id=1, player_name="A", game_id="G1",
            game_date=date.today(), rest_days=5,
            woba_last_14d=0.300, woba_last_7d=0.350,
            hard_hit_pct_last_14d=0.45, hard_hit_pct_last_7d=0.44,
        )
    ...
    def test_hard_hit_drop(self):
        ...
        r = d.evaluate_batter_fatigue(
            player_id=1, player_name="A", game_id="G1",
            game_date=date.today(), rest_days=5,
            woba_last_14d=0.350, woba_last_7d=0.340,
            hard_hit_pct_last_14d=0.50, hard_hit_pct_last_7d=0.35,
        )
    ...
    def test_no_hard_hit_drop(self):
        ...
        r = d.evaluate_batter_fatigue(
            ...
            game_date=date.today(), rest_days=5,
            woba_last_14d=0.350, woba_last_7d=0.340,
            hard_hit_pct_last_14d=0.40, hard_hit_pct_last_7d=0.45,
        )
    ...
    def test_batter_high_risk(self):
        ...
        r = d.evaluate_batter_fatigue(
            player_id=1, player_name="A", game_id="G1",
            game_date=date.today(), rest_days=0,
            woba_last_14d=0.400, woba_last_7d=0.200,
            hard_hit_pct_last_14d=0.60, hard_hit_pct_last_7d=0.20,
            tz_crossings_last_3d=4, travel_miles_last_3d=3000,
            is_day_game_after_night=True,
        )
        assert r.is_high_risk is True
    ...
    def test_overall_capped(self):
        ...
        r = d.evaluate_batter_fatigue(
            player_id=1, player_name="A", game_id="G1",
            game_date=date.today(), rest_days=0,
            woba_last_14d=1.000, woba_last_7d=0.000,
            hard_hit_pct_last_14d=1.00, hard_hit_pct_last_7d=0.00,
            tz_crossings_last_3d=13, travel_miles_last_3d=30000,
            is_day_game_after_night=True,
        )
        assert r.overall_fatigue <= 1.0
